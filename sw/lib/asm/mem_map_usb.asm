...
USB_IRQ_STATUS  equ $00F18000   ; Read-only pending bits: bit 0 Host 1, bit 1 Host 2. Does not acknowledge either host.
USB_IRQ_ENABLE  equ $00F18002   ; Read/write mask bits: bit 0 Host 1, bit 1 Host 2. Reset value $0000 disables USB CPU interrupts.

; --- USB Host 1 (word offsets 8-23; registers 13-23 reserved) ---
USB1_STATUS     equ $00F18010   ; Bit 7: conErr (1=Error). Bits 1-0: type (0=None, 1=KB, 2=Mouse, 3=Pad).
...
USB2_STATUS     equ $00F18030   ; Bit 7: conErr (1=Error). Bits 1-0: type (0=None, 1=KB, 2=Mouse, 3=Pad).
