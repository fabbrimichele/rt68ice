...
; --- USB Port 2 ---
USB2_STATUS     equ $0002400A   ; 16-bit. Bit 7: conErr (1=Error). Bits 1-0: Device Type (0=None, 1=KB, 2=Mouse, 3=Pad).
USB2_MOUSE_BTN  equ $0002400C   ; 16-bit. Mouse buttons. Bit 0: Left, Bit 1: Right, Bit 2: Middle.
USB2_MOUSE_DX   equ $0002400E   ; 16-bit. X-axis delta. Lower 8 bits contain 2's complement signed accumulator.
USB2_MOUSE_DY   equ $00024010   ; 16-bit. Y-axis delta. Lower 8 bits contain 2's complement signed accumulator.
USB2_GAMEPAD    equ $00024012   ; 16-bit. Packed inputs. Bits 9-0: U, D, L, R, A, B, X, Y, Start, Select.